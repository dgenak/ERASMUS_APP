...
<body>
  ...
  <main>
    ...
    <div id="newPostForm" style="display:none;">
      ...
      <button class="btn primary" onclick="submitPost()"><i class="fa-solid fa-paper-plane"></i> Post</button>
      <button class="btn secondary" onclick="closeNewPostForm()">Cancel</button>
    </div>
  </main>
  ...
  <script>
          ...
          const postHtml = `
            <div class="post">
              ...
              <div class="post-footer">
                ...
                <span onclick="toggleReplyForm(\${p.id})"><i class="fa-solid fa-reply"></i> Answer</span>
              </div>
              <div class="reply-form" id="replyForm-\${p.id}" style="display:none;">
                <textarea id="replyText-\${p.id}" placeholder="Write your reply..."></textarea>
                <button class="btn primary" onclick="submitReply(\${p.id})">Submit</button>
              </div>
              \${repliesHtml}
            </div>
          `;
    ...
    async function submitReply(id) {
      ...
      if (!text) {
        alert('Write something before submitting your reply');
        return;
      }
